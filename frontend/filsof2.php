    ...
    <div class="row align-items-md-stretch py-5 m-2">
        <div class="col-md-4">
            <div class="h-100 p-5 text-bg-light rounded-3">
                <img src="../frontend/picture/filsafat.jpeg" alt="" width="300" height="400">
            </div>
        </div>
        <div class="col-md-8">
            <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <h4>Filsafat dari Masa ke Masa</h4>
                <p style="color:dimgray;">4.6.0 <i class="fa-solid fa-star" style="color: #ffea00;"></i><i class="fa-solid fa-star" style="color: #ffea00;"></i><i class="fa-solid fa-star" style="color: #ffea00;"></i><i class="fa-solid fa-star" style="color: #ffea00;"></i>
                <i class="fa-solid fa-star-half" style="color: #ffea00;"></i> | 1.9k Penilaian | 2.1k Terjual</p>
                <h2 style="color:cornflowerblue;">Rp.98.000</h2>
                <p style="color:cadetblue;">Philosopy | Edukasi | C02 | </p>
                ...
                <form action="filsof2.php" method="post" name="form1">
