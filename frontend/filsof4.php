    ...
    <div class="row align-items-md-stretch py-5 m-2">
        <div class="col-md-4">
            <div class="h-100 p-5 text-bg-light rounded-3">
                <img src="../frontend/picture/filsafat3.jpeg" alt="" width="300" height="400">
            </div>
        </div>
        <div class="col-md-8">
            <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <h4>Sejarah Filsuf Dunia</h4>
                <p style="color:dimgray;">4.7 <i class="fa-solid fa-star" style="color: #ffea00;"></i><i class="fa-solid fa-star" style="color: #ffea00;"></i><i class="fa-solid fa-star" style="color: #ffea00;"></i><i class="fa-solid fa-star" style="color: #ffea00;"></i>
                <i class="fa-solid fa-star-half" style="color: #ffea00;"></i> | 4.1k Penilaian | 6.1k Terjual</p>
                <h2 style="color:cornflowerblue;">Rp.156.000</h2>
                <p style="color:cadetblue;">Philosopy | Edukasi | C04 | </p>
                ...
                <form action="filsof4.php" method="post" name="form1">
