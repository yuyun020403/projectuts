    ...
    <div class="row align-items-md-stretch py-5 m-2">
        <div class="col-md-4">
            <div class="h-100 p-5 text-bg-light rounded-3">
                <img src="../frontend/picture/the hobbit..jpeg" alt="" width="300" height="400">
            </div>
        </div>
        <div class="col-md-8">
            <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                ...
                <i class="fa-solid fa-star" style="color: #a8b2c2;"></i> | 77 Penilaian | 54 Terjual</p>
                <h2 style="color:cornflowerblue;">Rp.125.000</h2>
                <p style="color:cadetblue;">Fantasi | Petualangan | A02 | </p>
                ...
                <form action="hobbit.php" method="post" name="form1">
