    ...
    <div class="row align-items-md-stretch py-5 m-2">
        <div class="col-md-4">
            <div class="h-100 p-5 text-bg-light rounded-3">
                <img src="../frontend/picture/sejarah dunia.jpeg" alt="" width="300" height="400">
            </div>
        </div>
        <div class="col-md-8">
            <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <h4>Sejarah DUNIA yang di Sembunyikan</h4>
                ...
                <i class="fa-solid fa-star-half" style="color: #ffea00;"></i> |  3.3k Penilaian | 5.1k Terjual</p>
                <h2 style="color:cornflowerblue;">Rp.200.000</h2>
                <p style="color:cadetblue;">History | Edukasi | B02 | </p>
                ...
                <form action="sejarah2.php" method="post" name="form1">
