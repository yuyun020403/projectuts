    ...
    <div class="row align-items-md-stretch py-5 m-2">
        <div class="col-md-4">
            <div class="h-100 p-5 text-bg-light rounded-3">
                <img src="../frontend/picture/filsafat2.jpeg" alt="" width="300" height="400">
            </div>
        </div>
        <div class="col-md-8">
            <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <h4>Filsafat Pendidikan</h4>
                ...
                <i class="fa-solid fa-star-half" style="color: #ffea00;"></i> | 1.1k Penilaian | 2.1k Terjual</p>
                <h2 style="color:cornflowerblue;">Rp.125.000</h2>
                <p style="color:cadetblue;">Philosopy | Edukasi | C03 | </p>
                ...
                <form action="filsof3.php" method="post" name="form1">
