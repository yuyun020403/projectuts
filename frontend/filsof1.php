    ...
    <div class="row align-items-md-stretch py-5 m-2">
        <div class="col-md-4">
            <div class="h-100 p-5 text-bg-light rounded-3">
                <img src="../frontend/picture/filsof.jpg" alt="" width="300" height="400">
            </div>
        </div>
        <div class="col-md-8">
            <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                ...
                <i class="fa-solid fa-star" style="color: #ffea00;"></i> | 4.9k Penilaian | 8.1k Terjual</p>
                <h2 style="color:cornflowerblue;">Rp.100.000</h2>
                <p style="color:cadetblue;">Philosopy | Edukasi | C01 | </p>
                ...
                <form action="filsof1.php" method="post" name="form1">
