...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content" style="background-color: #9BA4B5;">
            ...
            <div class="col-md-3">
                <img style="border-radius: 100%;" src="../frontend/picture/ini yuyun.jpg" alt="" width="150" height="150">
            </div>
            <div class="col-md-6">
                <h2>Yuyun Trisma Hartati</h2>
                <h5>@Yuntrishg </h5>
                <p><i>I am a flower in my own garden</i></p>
                <div class="row align-items-md-stretch " >
                    <div class="col-md-3">
                        <p style="color:#394867; ">Social Media :</p>
                    </div>
                    <div class="col-md-6">
                    <p ><a style="text-decoration: none; color: #537188;" href="https://www.instagram.com/yuntrishg/"><i class="fa-brands fa-instagram" style="color: #022664;"></i> Instagram</a></p>
                    <p ><a style="text-decoration: none; color: #537188;" href="https://open.spotify.com/user/31isfu6ucasrjhg3gphnrbsg2b64"><i class="fa-brands fa-spotify" style="color: #022664;"></i> Spotify</a></p>
                    </div>
                </div>
            </div>
        </div>
