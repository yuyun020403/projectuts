            ...
            <main>
                <div class="container-fluid ">
                    ...
                    <ol class="breadcrumb mb-4">
                        <button type="button" class="btn btn-outline-dark"><a href="addproduk.php" style="text-decoration: none; color:sienna;">Tambah Produk</a></button>
                    </ol>
                    <div>
                        <table class="table  table-striped" style="background-color: #E4DCCF;">
                            ...
                            ?>
                                ...
                                <td>
                                    <a href="editproduk.php?id=<?php echo $data_produk['id'] ?>"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                    &nbsp; &nbsp;
                                    <a href="deleteproduk.php?id=<?php echo $data_produk['id'] ?>"><i class="fa-solid fa-trash" style="color: #ba0d0d;"></i></button></a>
                                </td>
                            <?php }
                            ?>
                            </thead>
